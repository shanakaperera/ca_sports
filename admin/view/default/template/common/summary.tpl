...
<!--ul>
    ...
    <li>
        ...
        <div class="stats_info">
            <span class="text-muted">
                {*<?php echo $text_today_orders; ?>*}
                </span>
            <h4>
                {*<?php echo $today_order_count; ?>*}
            </h4>
        </div>
    ...
    <li>
        ...
        <div class="stats_info">
            <span class="text-muted">
                {*<?php echo $text_today_sales; ?>*}
            </span>
            <h4>
                {*<?php echo $today_sales_amount; ?>*}
            </h4>
        </div>
    </li>
    <li>
        ...
        <div class="stats_info">
            <span class="text-muted">
                {*<?php echo $text_today_customers; ?>*}
            </span>
            <h4>
                {*<?php echo $today_customer_count; ?>*}
            </h4>
        </div>
    </li>
    <li>
        ...
        <div class="stats_info">
            <span class="text-muted">
                {*<?php echo $text_today_reviews; ?>*}
            </span>
            <h4>
                {*<?php echo $today_review_count; ?>*}
            </h4>
        </div>
    </li>
    <li>
        ...
        <div class="stats_info">
            <span class="text-muted">
                {*<?php echo $text_server_time; ?>*}
            </span>
            <h4>
                {*<?php echo $server_date .'<br>'.$server_time; ?>*}
            </h4>
            <span class="text-muted">
